                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz" method="POST">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="name" name="name" value="" placeholder="Enter Quiz title" class="form-control input-md" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="total" name="total" value="" placeholder="Enter total number of questions" class="form-control input-md" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="right" name="right" value="" placeholder="Enter marks on right answer" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="wrong" name="wrong" value="" placeholder="Enter minus marks on wrong answer without sign" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
